...
namespace IniWrapper.IntegrationTests.Main.Read
{
    ...
    public class IniParserReadPropertiesConfigurationTests
    {
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestInt)).Returns(value.ToString());
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestUint)).Returns(value.ToString());
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestChar)).Returns(value.ToString());
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestStringList)).Returns("a,b,c,d,f");
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestIntList)).Returns("1,2,3,4,5,6,7,8");
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestUintList)).Returns("1,2,3,4,5,6,7,8");
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestEnum)).Returns("Five");
        ...
        {
            _iniParserWrapper.Read(nameof(TestConfiguration), nameof(TestConfiguration.TestEnum)).Returns("1");
